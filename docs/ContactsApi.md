...
import type { AssignContactCategoryOperationRequest } from '@spatio-labs/spatio-ts';
...
import type { CreateContactOperationRequest } from '@spatio-labs/spatio-ts';
...
import type { CreateContactCategoryOperationRequest } from '@spatio-labs/spatio-ts';
...
import type { DeleteContactRequest } from '@spatio-labs/spatio-ts';
...
import type { DeleteContactCategoryRequest } from '@spatio-labs/spatio-ts';
...
import type { GetContactRequest } from '@spatio-labs/spatio-ts';
...
import type { ListContactCategoriesRequest } from '@spatio-labs/spatio-ts';
...
import type { ListContactProvidersRequest } from '@spatio-labs/spatio-ts';
...
import type { ListContactsRequest } from '@spatio-labs/spatio-ts';
...
import type { UnassignContactCategoryRequest } from '@spatio-labs/spatio-ts';
...
import type { UpdateContactOperationRequest } from '@spatio-labs/spatio-ts';
...
import type { UpdateContactCategoryOperationRequest } from '@spatio-labs/spatio-ts';
