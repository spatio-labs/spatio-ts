...
import type { GetJWKSRequest } from '@spatio-labs/spatio-ts';
...
import type { GetOAuthDiscoveryRequest } from '@spatio-labs/spatio-ts';
...
import type { GetOpenIDConfigurationRequest } from '@spatio-labs/spatio-ts';
...
import type { GetUserInfoRequest } from '@spatio-labs/spatio-ts';
...
import type { OauthAuthorizeRequest } from '@spatio-labs/spatio-ts';
...
import type { OauthIntrospectRequest } from '@spatio-labs/spatio-ts';
...
import type { OauthRevokeRequest } from '@spatio-labs/spatio-ts';
...
import type { OauthTokenRequest } from '@spatio-labs/spatio-ts';
...
import type { PostUserInfoRequest } from '@spatio-labs/spatio-ts';
...
import type { RegisterOAuthClientRequest } from '@spatio-labs/spatio-ts';
