...
import type { CreateAgentOperationRequest } from '@spatio/sdk-ts';
...
import type { CreateAgentConversationOperationRequest } from '@spatio/sdk-ts';
...
import type { CreateAgentMessageOperationRequest } from '@spatio/sdk-ts';
...
import type { DeleteAgentRequest } from '@spatio/sdk-ts';
...
import type { ExecuteAgentActionRequest } from '@spatio/sdk-ts';
...
import type { GetAgentRequest } from '@spatio/sdk-ts';
...
import type { GetAgentConversationRequest } from '@spatio/sdk-ts';
...
import type { GetAgentSessionContextRequest } from '@spatio/sdk-ts';
...
import type { ListAgentConversationMessagesRequest } from '@spatio/sdk-ts';
...
import type { ListAgentConversationsRequest } from '@spatio/sdk-ts';
...
import type { ListAgentsRequest } from '@spatio/sdk-ts';
...
import type { ListPreconfiguredAgentsRequest } from '@spatio/sdk-ts';
...
import type { UpdateAgentOperationRequest } from '@spatio/sdk-ts';
