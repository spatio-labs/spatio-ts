...
import type { GetInboxCountsRequest } from '@spatio-labs/spatio-ts';
...
import type { ListInboxRequest } from '@spatio-labs/spatio-ts';
...
import type { MarkInboxItemReadRequest } from '@spatio-labs/spatio-ts';
...
import type { WorkspaceGetInboxCountsRequest } from '@spatio-labs/spatio-ts';
...
import type { WorkspaceListInboxRequest } from '@spatio-labs/spatio-ts';
...
import type { WorkspaceMarkInboxItemReadRequest } from '@spatio-labs/spatio-ts';
