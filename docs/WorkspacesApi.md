...
import type { AcceptWorkspaceInvitationRequest } from '@spatio/sdk-ts';
...
import type { AddWorkspaceMemberOperationRequest } from '@spatio/sdk-ts';
...
import type { CreateWorkspaceOperationRequest } from '@spatio/sdk-ts';
...
import type { CreateWorkspaceInvitationOperationRequest } from '@spatio/sdk-ts';
...
import type { GetPublicInvitationRequest } from '@spatio/sdk-ts';
...
import type { GetWorkspaceRequest } from '@spatio/sdk-ts';
...
import type { ListMyWorkspacesRequest } from '@spatio/sdk-ts';
...
import type { ListWorkspaceInvitationsRequest } from '@spatio/sdk-ts';
...
import type { ListWorkspaceMembersRequest } from '@spatio/sdk-ts';
...
import type { RemoveWorkspaceMemberRequest } from '@spatio/sdk-ts';
...
import type { RevokeWorkspaceInvitationRequest } from '@spatio/sdk-ts';
...
import type { UpdateWorkspaceOperationRequest } from '@spatio/sdk-ts';
...
import type { UpdateWorkspaceMemberOperationRequest } from '@spatio/sdk-ts';
