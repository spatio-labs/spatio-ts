...
import type { DeletePinnedPlatformRequest } from '@spatio/sdk-ts';
...
import type { GetBootstrapRequest } from '@spatio/sdk-ts';
...
import type { GetOnboardingInvitationsRequest } from '@spatio/sdk-ts';
...
import type { GetPinnedPlatformsRequest } from '@spatio/sdk-ts';
...
import type { GetPlatformPreferencesRequest } from '@spatio/sdk-ts';
...
import type { GetPlatformSettingsLegacyRequest } from '@spatio/sdk-ts';
...
import type { GetThreadsStatusRequest } from '@spatio/sdk-ts';
...
import type { GetUserPermissionsRequest } from '@spatio/sdk-ts';
...
import type { GetWorkspaceActivityRequest } from '@spatio/sdk-ts';
...
import type { GetWorkspaceLayoutRequest } from '@spatio/sdk-ts';
...
import type { PutPinnedPlatformRequest } from '@spatio/sdk-ts';
...
import type { PutPlatformPreferencesRequest } from '@spatio/sdk-ts';
...
import type { PutWorkspaceLayoutRequest } from '@spatio/sdk-ts';
...
import type { ReorderPinnedPlatformsRequest } from '@spatio/sdk-ts';
...
import type { ResetPlatformPreferencesRequest } from '@spatio/sdk-ts';
...
import type { UpdateUserProfileRequest } from '@spatio/sdk-ts';
...
import type { ValidateOrganizationSlugRequest } from '@spatio/sdk-ts';
...
import type { ValidateWorkspaceSlugRequest } from '@spatio/sdk-ts';
