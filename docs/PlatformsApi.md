...
import type { AddPlatformProviderAccountRequest } from '@spatio/sdk-ts';
...
import type { CreateOrUpdatePlatformSecretRequest } from '@spatio/sdk-ts';
...
import type { DeletePlatformSecretRequest } from '@spatio/sdk-ts';
...
import type { ExecPlatformDataRequest } from '@spatio/sdk-ts';
...
import type { ExportPlatformSecretsRequest } from '@spatio/sdk-ts';
...
import type { GeneratePlatformBackendTokenRequest } from '@spatio/sdk-ts';
...
import type { GetPlatformCatalogRequest } from '@spatio/sdk-ts';
...
import type { GetPlatformManifestRequest } from '@spatio/sdk-ts';
...
import type { ListPlatformAccountsRequest } from '@spatio/sdk-ts';
...
import type { ListPlatformProvidersRequest } from '@spatio/sdk-ts';
...
import type { ListPlatformSecretsRequest } from '@spatio/sdk-ts';
...
import type { ListPlatformTablesRequest } from '@spatio/sdk-ts';
...
import type { ListPlatformsRequest } from '@spatio/sdk-ts';
...
import type { QueryPlatformDataRequest } from '@spatio/sdk-ts';
...
import type { RunPlatformMigrationsRequest } from '@spatio/sdk-ts';
