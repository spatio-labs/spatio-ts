...
import type { CreateCalendarEventRequest } from '@spatio/sdk-ts';
...
import type { DeleteCalendarEventRequest } from '@spatio/sdk-ts';
...
import type { GetCalendarCapabilitiesRequest } from '@spatio/sdk-ts';
...
import type { GetCalendarEventRequest } from '@spatio/sdk-ts';
...
import type { ListCalendarEventsRequest } from '@spatio/sdk-ts';
...
import type { ListCalendarProvidersRequest } from '@spatio/sdk-ts';
...
import type { SyncCalendarRequest } from '@spatio/sdk-ts';
...
import type { UpdateCalendarEventRequest } from '@spatio/sdk-ts';
...
import type { WorkspaceCreateCalendarEventRequest } from '@spatio/sdk-ts';
...
import type { WorkspaceDeleteCalendarEventRequest } from '@spatio/sdk-ts';
...
import type { WorkspaceGetCalendarEventRequest } from '@spatio/sdk-ts';
...
import type { WorkspaceListCalendarEventsRequest } from '@spatio/sdk-ts';
...
import type { WorkspaceListCalendarProvidersRequest } from '@spatio/sdk-ts';
...
import type { WorkspaceUpdateCalendarEventRequest } from '@spatio/sdk-ts';
