...
import type { AddNativeDMReactionRequest } from '@spatio/sdk-ts';
...
import type { AttachToNativeDMMessageRequest } from '@spatio/sdk-ts';
...
import type { DeleteNativeDMMessageRequest } from '@spatio/sdk-ts';
...
import type { ForwardNativeDMMessageRequest } from '@spatio/sdk-ts';
...
import type { ListNativeDMChannelsRequest } from '@spatio/sdk-ts';
...
import type { ListNativeDMConversationsRequest } from '@spatio/sdk-ts';
...
import type { ListNativeDMMessagesRequest } from '@spatio/sdk-ts';
...
import type { ListNativeDMPinnedMessagesRequest } from '@spatio/sdk-ts';
...
import type { ListNativeDMThreadRepliesRequest } from '@spatio/sdk-ts';
...
import type { MarkNativeDMReadRequest } from '@spatio/sdk-ts';
...
import type { MuteNativeDMRequest } from '@spatio/sdk-ts';
...
import type { PinNativeDMConversationRequest } from '@spatio/sdk-ts';
...
import type { PinNativeDMMessageRequest } from '@spatio/sdk-ts';
...
import type { PostNativeDMMessageRequest } from '@spatio/sdk-ts';
...
import type { PostNativeDMThreadReplyRequest } from '@spatio/sdk-ts';
...
import type { RemoveNativeDMReactionRequest } from '@spatio/sdk-ts';
...
import type { SearchNativeDMMessagesRequest } from '@spatio/sdk-ts';
...
import type { SetNativeDMDraftRequest } from '@spatio/sdk-ts';
...
import type { UnpinNativeDMConversationRequest } from '@spatio/sdk-ts';
...
import type { UnpinNativeDMMessageRequest } from '@spatio/sdk-ts';
...
import type { UpdateNativeDMMessageRequest } from '@spatio/sdk-ts';
